...
//    @Test
//    public void Task1_WithoutSpaces() {
//        final String resultString = "JAVA JAVA JAVA JAVA JAVA JAVA JAVA JAVA JAVA JAVA";
//        Task1.main(new String[0]);
//        assertEquals(resultString, getOutput(), "Количество повторений слова \"JAVA\", в строке, не равно десяти, либо в строке присутствует лишний пробел");
//    }
